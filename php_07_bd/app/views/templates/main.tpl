...
<div class="pure-menu pure-menu-horizontal bottom-margin">
    <a href="{$conf->action_root}calcShow" class="pure-menu-heading pure-menu-link">Kalkulator Kredytowy</a>
    <a href="{$conf->action_root}calcHistory" class="pure-menu-heading pure-menu-link">Historia</a>
